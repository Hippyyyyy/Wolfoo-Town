...
namespace SCN.Ads
{
	...
	public class AdmobConfig : ScriptableObject
	{
        ...
        [Header("Native Id")]
        [SerializeField]
        private bool useNativeAd = false;

        [SerializeField]
        private string native_ID_android;
        [SerializeField]
        private string native_ID_ios;
	...
	//	public string AdUnityAppID => IsAndroid ? adUnityAppID_android : adUnityAppID_iOS;
        ...
        public string NativeID
        {
            get
            {
                ...
                if (IsAndroid)
                {
                    return (!UseTestID) ? native_ID_android : "ca-app-pub-3940256099942544/2247696110";
                }
                return (!UseTestID) ? native_ID_ios : "ca-app-pub-3940256099942544/3986624511";
            }
        }

        public bool UseNativeAd { get => useNativeAd; set => useNativeAd = value; }
    }
}