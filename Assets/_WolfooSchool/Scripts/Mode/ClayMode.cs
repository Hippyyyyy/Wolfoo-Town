...
namespace _WolfooSchool
{
    public class ClayMode : Panel
    {
                ...
                curShapeItems = item.flowerBox.OnGetItem(() =>
                {
                    ...
                    item.flowerBox.OnCloseLid(() =>
                    {
                        item.flowerBox.MoveOut(Direction.Left, 0.5f, () =>
                        {
                            ...
                            TutorialManager.Instance.StartPointer(curShapeItems[2].transform.position, Gesture.Click);
                        });
                    });
                });
            });
        ...
        {
            Debug.Log("On NExt Session " + curIdxSession);
            switch (curIdxSession)
            {
                ...
                case 1:
                    ...
                    peeler.MoveOut(Direction.Right, 0.5f, () =>
                    {
                        ...
                        {
                            TutorialManager.Instance.StartPointer(shapeBoard.transform.position, Gesture.Click);
                        });
                    });
                    break;
                case 2:
                ...
                case 3:
                    ...
                    delayTween = DOVirtual.DelayedCall(1, () =>
                    {
                        ...
                        petalBoard.MoveInBack(0.5f, () =>
                        {
                            ...
                            TutorialManager.Instance.StartPointer(petalBoard.transform.position, pistil.transform.position, Gesture.Hold);
                        });
                    });
                    break;
                case 4:
                ...
                case 5:
                    ...
                    flower.MoveToEndPos(() =>
                    {
                        ...
                        trunkBoard.MoveInBack(0.5f, () =>
                        {
                            ...
                            TutorialManager.Instance.StartPointer(trunkBoard.transform.position, pistil.transform.position, Gesture.Hold);
                        });
                    }, false);
                    break;
                case 6:
                    ...
                    flower.MoveToEndPos(() =>
                    {
                        ...
                        leafBoard.MoveInBack(0.5f, () =>
                        {
                            ...
                            TutorialManager.Instance.StartPointer(leafBoard.transform.position, flower.LeafZone.position, Gesture.Hold);
                        });
                    }, false);
                    break;
                case 7:
                    ...
                    delayTween = DOVirtual.DelayedCall(0.5f, () =>
                    {
                        ...
                        {
                            TutorialManager.Instance.StartPointer(potScroll.transform.position, pot.transform.position, Gesture.Hold);
                        });
                    });
                    break;
                case 8:
